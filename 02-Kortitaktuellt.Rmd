...
- Esimerkki: Menieren tautiin halutaan silmät ensimmäiseksi, koska kortti käsittelee sitä ja halutaan heti viestiä, että "Hei, nyt puhutaan Menieren taudista eikä mistään muusta". Sitten on makukysymys, haluaako korostaa enemmän hoitoa vai akuuttivaihetta, mutta molemmat korostetaan jollain tavalla ja tässä olen tässä halunnut tuoda enemmän akuuttivaihetta esiin (tämän takia valinnut alleviivauksen), koska on toisia kortteja, joissa taas kysytään enemmänkin rauhallisen vaiheen hoidosta kohtausten eston suhteen.
...
![](images/typografiaclozeissa.png)

## Tägäys {#Tagays}

Suuremmissa kokonaisuuksissa kannattaa ainakin ensimmäisillä kerroilla neuvotella minun kanssa, miten tägäys kannattaa toteuttaa, mutta yksittäisissä korteissa voi seurata jo valmista tägimaailmaa. 